...
async function renderApp(autoRefresh = true, summaryOverride: Partial<Summary> = {}) {
  ...
  vi.doMock('./api/client', () => ({
    api: {
      ...
      forensicRefresh: vi.fn().mockResolvedValue({
        sources_scanned: 0,
        events_processed: 0,
        events_skipped: 0,
        malformed_events: 0,
      ...
      forensicSessions: vi.fn().mockResolvedValue({ items: [], limit: 50, offset: 0, has_more: false }),
      ...
      forensicExport: vi.fn().mockResolvedValue({
        ...
        export_type: 'summary',
        created_at_utc: '2026-07-26T22:05:00Z',
      }),
